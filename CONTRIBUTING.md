...
Please **[open an issue first](https://github.com/SIH-ELITE-CODERS/parakh-core/issues/new)** for any bug report or new feature if there isn't
...
open issues listed at the [issues page](https://github.com/SIH-ELITE-CODERS/parakh-core/issues/

For newcomers, issues with minor complexity are tagged
as [good first issue](https://github.com/SIH-ELITE-CODERS/parakh-core/labels/good-first-issue).
...
For example, if you work on the backend prefix it with `backend: my message`,
